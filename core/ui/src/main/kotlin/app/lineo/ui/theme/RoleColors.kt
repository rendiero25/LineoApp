...
data class RoleColors(val container: Color, val content: Color) {
    ...
    companion object {
        ...
        fun of(scheme: ColorScheme, role: LineoRole): RoleColors = when (role) {
            LineoRole.Digit -> RoleColors(scheme.surfaceContainerHighest, scheme.onSurface)
            ...
            LineoRole.InputSwitch -> RoleColors(scheme.inverseSurface, scheme.inverseOnSurface)
